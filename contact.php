...
<?php include("includes/header.php"); ?>
			<div id="content">
				<h6>Contact</h6>
				<p>Thanks for visiting my portfolio! For questions, comments, or hiring inquiries please send email to: <a href="mailto:donna.almendrala@gmail.com">donna.almendrala@gmail.com</a></p>
				<h6>About Me</h6>
				...
				<ul>
					...
					<li><a href="http://www.pythoncomics.com" target="_blank">Python Comics</a>: a webcomic to spread the good news of Python</li>
